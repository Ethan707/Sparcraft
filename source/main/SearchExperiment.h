...
class SearchExperiment {
    ...
    void addState(const std::string &line, const std::string &num);
    void padString(std::string &str, const size_t &length);
    void setCurrentDateTime();
    std::string getDateTimeString();
    svv getExpDescription(const size_t &p1, const size_t &p2,
                          const size_t &state);

    std::vector<std::string> getLines(const std::string &filename);

    Position getRandomPosition(const PositionType &xlimit,
                               const PositionType &ylimit);

    void addSeparatedState(std::vector<std::string> &unitTypes,
                           std::vector<int> &numUnits, const int cx1,
                           const int cy1, const int cx2, const int cy2,
                           const PositionType &xLimit,
                           const PositionType &yLimit);

    GameState getSymmetricState(std::vector<std::string> &unitTypes,
                                std::vector<int> &numUnits,
                                const PositionType &xLimit,
                                const PositionType &yLimit);
    GameState getSymmetricVerticalLineState(std::vector<std::string> &unitTypes,
                                            std::vector<int> &numUnits,
                                            const PositionType &xLimit,
                                            const PositionType &yLimit);
  ...
  public:
    SearchExperiment(const std::string &configFile, const std::string &num);
    ~SearchExperiment();
