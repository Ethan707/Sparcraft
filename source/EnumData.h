...
namespace SparCraft
{
    ...
    template <class T>
    std::string EnumData<T>::name;
    template <class T>
    std::vector<std::string> EnumData<T>::names;
    template <class T>
    std::map<std::string, int> EnumData<T>::nameMap;
    ...
    public:
        enum
        {
            ...
            ImprovedPortfolioGreedySearch,
            UCT,
            StratifiedPolicySearch,
            AdaptableStratifiedPolicySearch,
            IRStratifiedPolicySearch,
            PortfolioOnlineEvolution,
            MoveForward,
            MoveBackward,
            None,
            Size
