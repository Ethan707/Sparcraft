...
TTEntry::TTEntry()
	: _hash2(0), _depth(0), _type(TTEntry::NONE)
{
}
...
TTEntry::TTEntry(const HashType &hash2, const StateEvalScore &score, const size_t &depth, const int &type,
	...
	: _hash2(hash2), _score(score), _depth(depth), _type(type)
{
...
TranspositionTable::TranspositionTable()
	: TT(Constants::Transposition_Table_Size, TTEntry()), size(Constants::Transposition_Table_Size), collisions(0), lookups(0), found(0), notFound(0), saves(0), minIndex(0), maxIndex(0), saveOverwriteSelf(0), saveOverwriteOther(0), saveEmpty(0)
{
}
