...
GUI::GUI(int width, int height)
    : _initialWidth(width), _initialHeight(height), _cameraX(0), _cameraY(0), _previousMouseX(0), _previousMouseY(0), _isStarted(false), _mousePressed(false), _shiftPressed(false), _currentFrame(0), _previousRenderTime(0), _guiGame(*this)
{
...
void GUI::loadTextures()
{
    ...
    std::string imageDir = "/home/ethan/workspace/Sparcraft/asset/images/";
